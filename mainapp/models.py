...
class Placement(models.Model):
    ...
    choicea = models.BooleanField(default=False)
    choiceb = models.BooleanField(default=False)
    choicec = models.BooleanField(default=False)
    choiced = models.BooleanField(default=False)
    choicee = models.BooleanField(default=False)
